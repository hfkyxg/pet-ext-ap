...
const clawdCatalogGlobals = {
  ...
  clawdSubPetFrameToDataUrl: 'readonly',
  clawdTintSubPetImage: 'readonly',
  clawdSubPetHasCustomPalette: 'readonly',
  clawdNormalizeHexColor: 'readonly',
  clawdShadePixelColor: 'readonly',
