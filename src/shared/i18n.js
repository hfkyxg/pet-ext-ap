...
var CLAWD_I18N_UI = {
  'pt-BR': {
    ...
    /* v6 — Foco & Bem-estar */
    tab_focus: 'Foco & Bem-estar',
    hint_focus: 'Use bem seu tempo: Pomodoro, menos rolagem infinita e lembretes de bem-estar.',
    focus_idle: 'Pronto para focar', focus_start: '▶ Iniciar foco', focus_restart: '↻ Reiniciar',
    focus_pause: 'Pausar/Retomar', focus_skip: 'Pular fase', focus_stop: 'Parar',
    focus_phase_work: 'Foco', focus_phase_break: 'Pausa', focus_phase_long: 'Pausa longa',
    focus_sessions: '{0} sessões hoje',
    focus_work: 'Foco', focus_break: 'Pausa', focus_longbreak: 'Pausa longa', focus_cycles: 'Ciclos/longa',
    focus_autostart: '▶️ Auto-iniciar próxima fase', focus_autostart_desc: 'Encadeia foco e pausa sem clique.',
    screentime_title: '📊 Tempo de tela hoje',
    st_total: 'Total', st_focus: 'Em foco', st_timesink: 'Rolagem', st_empty: 'Sem dados ainda hoje.',
    timesink_guard: '🛑 Guarda anti-rolagem', timesink_guard_desc: 'O pet intervém em TikTok/Shorts/Reels e afins.',
    timesink_limit: 'Limite (min)', timesink_nudge: 'Gentil', timesink_firm: 'Firme',
    wellbeing_title: '🌿 Bem-estar', mood_prompt: 'Como você está?',
    calm_tools_title: '🫶 Central de calma', calm_tools_desc: 'Práticas curtas para desacelerar e voltar ao presente, no seu ritmo.',
    breathe_now: 'Reset de 1 minuto', breathe_started: 'Respire fundo… 🌬️',
    grounding_now: 'Grounding 5-4-3-2-1', grounding_started: 'Grounding aberto na página 🌿',
    calm_sounds_title: 'Assinaturas sonoras curtas', calm_sounds_aria: 'Sons curtos para uma pausa calma',
    calm_rain: 'Chuva', calm_waves: 'Ondas', calm_forest: 'Floresta', calm_purr: 'Ronronar',
    calm_sound_played: 'Som tocado na página.', calm_sound_unlock: 'Ative os sons e toque ou clique na página para liberar o áudio.',
    wellbeing_disclaimer: 'Ferramentas de apoio ao bem-estar; não substituem cuidado profissional.',
    wellbeing_progress_title: '📈 Seu ritmo', wellbeing_local_note: 'Humor e práticas ficam somente neste navegador.',
    wb_metric_mood: 'humor médio · 7 dias', wb_metric_practices: 'práticas · 7 dias', wb_metric_streak: 'dias em sequência',
    wb_rec_low: 'Hoje parece mais pesado. Experimente o grounding no seu ritmo ou apenas uma expiração longa.',
    wb_rec_screen: 'Sua rolagem passou do limite escolhido. Uma pausa curta longe da tela pode ajudar a desacelerar.',
    wb_rec_start: 'Comece pequeno: uma prática de um minuto já conta.',
    wb_rec_steady: 'Você está criando espaço para pausas. Continue no ritmo que fizer sentido.',
    mood_logged: 'Humor registrado 💙',
    wb_reminders: '🔔 Lembretes de bem-estar', wb_eye: '👀 Descanso ocular 20-20-20',
    wb_water: '💧 Lembrete de hidratação', wb_posture: '🪑 Lembrete de postura',
    wb_affirm: '✨ Afirmações positivas', wb_breathe_break: '🌬️ Respirar nas pausas do foco',
    label_site_rules: '🎯 Regras por site',
    label_site_rules_desc: 'Escolha como o Claw\'d age em cada site: bloquear, cutucar, limitar, impulsionar ou ignorar.',
    rule_block: 'Bloquear pet', rule_nudge: 'Cutucar', rule_limit: 'Limitar (firme)', rule_boost: 'Impulsionar', rule_off: 'Ignorar',
    rule_add: 'Adicionar', rule_add_current: '➕ Adicionar site atual', rule_empty: 'Nenhuma regra ainda.',
    rule_invalid: 'Domínio inválido.', rule_remove: 'Remover',
    cat_coding: 'Código', cat_music: 'Música', cat_video: 'Vídeo', cat_shopping: 'Compras',
    cat_social: 'Social', cat_news: 'Notícias', cat_email: 'E-mail', cat_gaming: 'Games',
    cat_health: 'Saúde', cat_learning: 'Estudos', cat_other: 'Outros'
  },
  en: {
    ...
    /* v6 — Focus & Wellbeing */
    tab_focus: 'Focus & Wellbeing',
    hint_focus: 'Use your time well: Pomodoro, less doomscrolling, and gentle wellbeing nudges.',
    focus_idle: 'Ready to focus', focus_start: '▶ Start focus', focus_restart: '↻ Restart',
    focus_pause: 'Pause/Resume', focus_skip: 'Skip phase', focus_stop: 'Stop',
    focus_phase_work: 'Focus', focus_phase_break: 'Break', focus_phase_long: 'Long break',
    focus_sessions: '{0} sessions today',
    focus_work: 'Focus', focus_break: 'Break', focus_longbreak: 'Long break', focus_cycles: 'Cycles/long',
    focus_autostart: '▶️ Auto-start next phase', focus_autostart_desc: 'Chain focus and breaks without a click.',
    screentime_title: '📊 Screen time today',
    st_total: 'Total', st_focus: 'Focused', st_timesink: 'Scrolling', st_empty: 'No data yet today.',
    timesink_guard: '🛑 Doomscroll guard', timesink_guard_desc: 'The pet steps in on TikTok/Shorts/Reels and the like.',
    timesink_limit: 'Limit (min)', timesink_nudge: 'Gentle', timesink_firm: 'Firm',
    wellbeing_title: '🌿 Wellbeing', mood_prompt: 'How are you?',
    calm_tools_title: '🫶 Calm center', calm_tools_desc: 'Short practices to slow down and return to the present, at your pace.',
    breathe_now: '1-minute reset', breathe_started: 'Breathe deeply… 🌬️',
    grounding_now: '5-4-3-2-1 grounding', grounding_started: 'Grounding opened on the page 🌿',
    calm_sounds_title: 'Short sound signatures', calm_sounds_aria: 'Short sounds for a calm pause',
    calm_rain: 'Rain', calm_waves: 'Waves', calm_forest: 'Forest', calm_purr: 'Purr',
    calm_sound_played: 'Sound played on the page.', calm_sound_unlock: 'Enable sounds, then tap or click the page to unlock audio.',
    wellbeing_disclaimer: 'Wellbeing support tools; they do not replace professional care.',
    wellbeing_progress_title: '📈 Your rhythm', wellbeing_local_note: 'Mood and practices stay only in this browser.',
    wb_metric_mood: 'avg. mood · 7 days', wb_metric_practices: 'practices · 7 days', wb_metric_streak: 'day streak',
    wb_rec_low: 'Today seems heavier. Try grounding at your pace, or simply take one long exhale.',
    wb_rec_screen: 'Scrolling passed your chosen limit. A short break away from the screen may help you slow down.',
    wb_rec_start: 'Start small: a one-minute practice still counts.',
    wb_rec_steady: 'You are making room for pauses. Keep the pace that feels right.',
    mood_logged: 'Mood logged 💙',
    wb_reminders: '🔔 Wellbeing reminders', wb_eye: '👀 20-20-20 eye rest',
    wb_water: '💧 Hydration reminder', wb_posture: '🪑 Posture reminder',
    wb_affirm: '✨ Positive affirmations', wb_breathe_break: '🌬️ Breathe on focus breaks',
    label_site_rules: '🎯 Per-site rules',
    label_site_rules_desc: 'Choose how Claw\'d behaves on each site: block, nudge, limit, boost, or ignore.',
    rule_block: 'Block pet', rule_nudge: 'Nudge', rule_limit: 'Limit (firm)', rule_boost: 'Boost', rule_off: 'Ignore',
    rule_add: 'Add', rule_add_current: '➕ Add current site', rule_empty: 'No rules yet.',
    rule_invalid: 'Invalid domain.', rule_remove: 'Remove',
    cat_coding: 'Code', cat_music: 'Music', cat_video: 'Video', cat_shopping: 'Shopping',
    cat_social: 'Social', cat_news: 'News', cat_email: 'Email', cat_gaming: 'Gaming',
    cat_health: 'Health', cat_learning: 'Learning', cat_other: 'Other'
  },
  es: {
...
var CLAWD_I18N_EXTRA = {
  'pt-BR': {
    ...
    stat_happiness: 'Felicidade',
    stat_hunger: 'Saciedade',
    stat_energy: 'Energia',
    stat_hygiene: 'Higiene',
    stat_hint_happy: 'clique para dar carinho',
    stat_hint_feed: 'clique para alimentar',
    stat_hint_play: 'clique para brincar',
    stat_hint_bath: 'clique para banho',
    label_skin: 'Skin do corpo',
    label_acc_head: 'Acessório — Cabeça',
    label_acc_face: 'Acessório — Rosto',
    label_acc_body: 'Acessório — Corpo',
    badge_new: 'NOVO',
    hint_acc_head: 'Escolha um chapéu para ver os detalhes.',
    hint_acc_face: 'Escolha um acessório para ver os detalhes.',
    hint_acc_body: 'Escolha um item de corpo para ver os detalhes.',
    hint_profession: 'A profissão define o comportamento e as reações do pet ao contexto da página.',
    label_jersey: 'Camisa do time',
    keepy_record_fmt: '⚽ Recorde de embaixadinhas:',
    prof_idle_status: 'Modo livre — sem profissão ativa',
    label_travel_freq: 'Frequência do passeio',
    label_personality: '🧠 Personalidade',
    hint_personality: 'Ajusta com que frequência o pet age de cada forma.',
    pers_playful: '🎪 Brincalhão',
    pers_lazy: '😴 Preguiçoso',
    pers_curious: '🔎 Curioso',
    pers_social: '💬 Social',
    pers_foodie: '🍖 Comilão',
    preset_energetic: '⚡ Enérgico',
    preset_relaxed: '😌 Relaxado',
    preset_curious: '🔎 Curioso',
    hint_subpets: "O Claw'd também merece um pet! Desbloqueie subindo de nível. Só 1 ativo por vez.",
    label_subpet_name: 'Nome do sub-pet',
    label_subpet_color: 'Cor do sub-pet',
    label_subpet_eye: 'Cor dos olhos',
    label_eye_independent: 'Cor independente',
    subpet_interactions: 'Interações ao vivo',
    subpet_wake_hint: 'acorda ao interagir',
    subpet_inactive: 'Ative um sub-pet para brincar.',
    subpet_ready: 'está pronto para brincar.',
    hint_shop: 'Ganhe 🪙 PixelCoins navegando, brincando e completando desafios (≈1 coin a cada 5 XP).',
    ach_unlocked_fmt: '{0} / {1} desbloqueadas',
    streak_box_prefix: '🔥 Streak:',
    streak_days_one: '1 dia',
    streak_days_many: '{0} dias',
    streak_box_hint: ' — volte amanhã para bônus de XP!',
    label_particle_color: '🎨 Cor das partículas',
    hint_particle_color: 'Deixe vazio para usar a cor padrão das ações.',
    particle_default: '(padrão)',
    label_custom_speech: '💬 Frases personalizadas do pet',
    hint_custom_speech: 'O pet dirá essas frases aleatoriamente.',
    quiet_start: 'Início',
    quiet_end: 'Fim',
    quiet_clear: 'Limpar',
    daily_title: 'Missão diária',
    weekly_title: 'Desafio semanal',
    quest_claimed: 'Resgatada',
    quest_claim_coins: 'Resgatar +{0}',
    quest_reward_xp: '+{0} XP ao concluir',
    shop_owned: '✅ Comprado',
    shop_buy: 'Comprar',
    shop_equip: 'Equipar',
    shop_equipped: 'Equipada ✓',
    shop_decor_active: 'Decoração ativa ✓',
    shop_cant_afford: 'PixelCoins insuficientes',
    shop_cushion_hint: 'Almofada pixel aparece sob o pet na página',
    nick_click_use: 'Clique para usar',
    level_lock_fmt: '🔒 Nível {0}',
    quick_actions_aria: 'Ações rápidas',
    particle_color_title: 'Cor customizada das partículas',
    particle_clear_title: 'Usar padrão',
    acc_none: 'Nenhum',
    acc_slot_head: 'cabeça',
    acc_slot_face: 'rosto',
    acc_slot_body: 'corpo',
    acc_badge_body: 'CORPO',
    acc_badge_shop: '🔒 Loja',
    acc_badge_prof: 'PROF.',
    acc_remove_fmt: 'Remover acessório de {0}',
    acc_unlock_level: 'Desbloqueia no nível {0}',
    acc_buy_shop: 'Compre na Lojinha por {0} 🪙',
    acc_prof_temp: 'Equipado temporariamente pela profissão ativa',
    acc_empty_head: 'Sem chapéu selecionado.',
    acc_empty_face: 'Sem acessório de rosto selecionado.',
    acc_empty_body: 'Sem acessório de corpo selecionado.',
    acc_prof_in_use: '{0} {1} está em uso pela profissão. {2} volta no modo Livre.',
    acc_your_choice: 'Sua escolha {0}',
    acc_none_option: 'A opção sem acessório',
    outfit_none: 'Visual sem acessórios',
    outfit_smooth: 'liso sem grade',
    outfit_pixel: 'pixel-art',
    outfit_slots: 'três slots combináveis',
    fav_title: 'Favoritar',
    import_invalid: '❌ Arquivo inválido.',
    import_ok: '✅ Dados importados! Recarregue as abas.',
    reset_confirm_1: 'Resetar TODO o progresso? Isso não pode ser desfeito.',
    reset_confirm_2: 'Tem certeza absoluta?',
    reset_done: 'Progresso resetado.',
    trello_prompt_title: '— título:',
    trello_prompt_desc: 'Descrição (opcional):',
    status_need_real_site: 'Abra em um site real para aplicar ao vivo!',
    status_summoned: 'Pet convocado nesta guia! 🧳',
    status_already_here: 'Pet já está com você aqui! 🧳',
    status_reload: 'Recarregue a página e tente de novo.',
    status_studio_open: 'Studio aberto na página — arraste o cabeçalho para mover',
    status_pet_shown: 'Pet visível de novo!',
    status_pet_hidden: 'Pet oculto nesta guia.',
    status_rescued: 'Pet resgatado na tela!',
    status_stat_happy: 'Carinho enviado ❤️',
    status_stat_feed: 'Hora do lanche 🍖',
    status_stat_play: 'Vamos brincar! ⚡',
    status_stat_bath: 'Banho liberado 🧼',
    status_action_sent: 'Ação enviada!',
    status_quick_wave: 'Acenando 👋',
    status_quick_dance: 'Hora de dançar 🕺',
    status_quick_pose: 'Pose! 📸',
    status_quick_sleep: 'Boa noite 😴',
    status_quick_balloon: 'Balão! 🎈',
    status_quick_cheer: 'Yeah! 🎉',
    status_open_site_first: 'Abra um site real primeiro.',
    prof_active_fmt: '{0} ativo — {1}',
    prof_gear_fmt: ' · traje: {0}',
    label_eye_color: 'Cor dos olhos do pet'
  },
  en: {
    ...
    stat_hunger: 'Fullness',
    stat_energy: 'Energy',
    stat_hygiene: 'Hygiene',
    stat_hint_happy: 'click to pet',
    stat_hint_feed: 'click to feed',
    stat_hint_play: 'click to play',
    stat_hint_bath: 'click for a bath',
    label_skin: 'Body skin',
    label_acc_head: 'Accessory — Head',
    label_acc_face: 'Accessory — Face',
    label_acc_body: 'Accessory — Body',
    badge_new: 'NEW',
    hint_acc_head: 'Pick a hat to see details.',
    hint_acc_face: 'Pick an accessory to see details.',
    hint_acc_body: 'Pick a body item to see details.',
    hint_profession: 'Profession shapes behavior and reactions to the page context.',
    label_jersey: 'Team jersey',
    keepy_record_fmt: '⚽ Keepy-uppy record:',
    prof_idle_status: 'Free mode — no active profession',
    label_travel_freq: 'Travel frequency',
    label_personality: '🧠 Personality',
    hint_personality: 'How often the pet acts in each way.',
    pers_playful: '🎪 Playful',
    pers_lazy: '😴 Lazy',
    pers_curious: '🔎 Curious',
    pers_social: '💬 Social',
    pers_foodie: '🍖 Foodie',
    preset_energetic: '⚡ Energetic',
    preset_relaxed: '😌 Relaxed',
    preset_curious: '🔎 Curious',
    hint_subpets: "Claw'd deserves a pet too! Unlock by leveling up. Only 1 active at a time.",
    label_subpet_name: 'Sub-pet name',
    label_subpet_color: 'Sub-pet color',
    label_subpet_eye: 'Eye color',
    label_eye_independent: 'Independent color',
    subpet_interactions: 'Live interactions',
    subpet_wake_hint: 'wakes on interact',
    subpet_inactive: 'Activate a sub-pet to play.',
    subpet_ready: 'is ready to play.',
    hint_shop: 'Earn 🪙 PixelCoins by browsing, playing and completing challenges (≈1 coin per 5 XP).',
    ach_unlocked_fmt: '{0} / {1} unlocked',
    streak_box_prefix: '🔥 Streak:',
    streak_days_one: '1 day',
    streak_days_many: '{0} days',
    streak_box_hint: ' — come back tomorrow for XP bonus!',
    label_particle_color: '🎨 Particle color',
    hint_particle_color: 'Leave empty to use the default action color.',
    particle_default: '(default)',
    label_custom_speech: '💬 Custom pet phrases',
    hint_custom_speech: 'The pet will say these phrases at random.',
    quiet_start: 'Start',
    quiet_end: 'End',
    quiet_clear: 'Clear',
    daily_title: 'Daily quest',
    weekly_title: 'Weekly challenge',
    quest_claimed: 'Claimed',
    quest_claim_coins: 'Claim +{0}',
    quest_reward_xp: '+{0} XP on complete',
    shop_owned: '✅ Owned',
    shop_buy: 'Buy',
    shop_equip: 'Equip',
    shop_equipped: 'Equipped ✓',
    shop_decor_active: 'Decor active ✓',
    shop_cant_afford: 'Not enough PixelCoins',
    shop_cushion_hint: 'Pixel cushion appears under the pet on the page',
    nick_click_use: 'Click to use',
    level_lock_fmt: '🔒 Level {0}',
    quick_actions_aria: 'Quick actions',
    particle_color_title: 'Custom particle color',
    particle_clear_title: 'Use default',
    acc_none: 'None',
    acc_slot_head: 'head',
    acc_slot_face: 'face',
    acc_slot_body: 'body',
    ...
    acc_badge_shop: '🔒 Shop',
    acc_badge_prof: 'JOB',
    acc_remove_fmt: 'Remove {0} accessory',
    acc_unlock_level: 'Unlocks at level {0}',
    acc_buy_shop: 'Buy in the Shop for {0} 🪙',
    acc_prof_temp: 'Temporarily equipped by the active profession',
    acc_empty_head: 'No hat selected.',
    acc_empty_face: 'No face accessory selected.',
    acc_empty_body: 'No body accessory selected.',
    acc_prof_in_use: '{0} {1} is in use by the profession. {2} returns in Free mode.',
    acc_your_choice: 'Your pick {0}',
    acc_none_option: 'The no-accessory option',
    outfit_none: 'Look with no accessories',
    outfit_smooth: 'smooth no grid',
    outfit_pixel: 'pixel-art',
    outfit_slots: 'three combinable slots',
    fav_title: 'Favorite',
    import_invalid: '❌ Invalid file.',
    import_ok: '✅ Data imported! Reload your tabs.',
    reset_confirm_1: 'Reset ALL progress? This cannot be undone.',
    reset_confirm_2: 'Are you absolutely sure?',
    reset_done: 'Progress reset.',
    trello_prompt_title: '— title:',
    trello_prompt_desc: 'Description (optional):',
    status_need_real_site: 'Open a real website to apply live!',
    status_summoned: 'Pet summoned to this tab! 🧳',
    status_already_here: 'Pet is already with you here! 🧳',
    status_reload: 'Reload the page and try again.',
    status_studio_open: 'Studio open on the page — drag the header to move',
    status_pet_shown: 'Pet visible again!',
    status_pet_hidden: 'Pet hidden on this tab.',
    status_rescued: 'Pet rescued on screen!',
    status_stat_happy: 'Pets sent ❤️',
    status_stat_feed: 'Snack time 🍖',
    status_stat_play: "Let's play! ⚡",
    status_stat_bath: 'Bath unlocked 🧼',
    status_action_sent: 'Action sent!',
    status_quick_wave: 'Waving 👋',
    status_quick_dance: 'Dance time 🕺',
    status_quick_pose: 'Pose! 📸',
    status_quick_sleep: 'Good night 😴',
    status_quick_balloon: 'Balloon! 🎈',
    status_quick_cheer: 'Yeah! 🎉',
    status_open_site_first: 'Open a real website first.',
    prof_active_fmt: '{0} active — {1}',
    prof_gear_fmt: ' · outfit: {0}',
    label_eye_color: 'Pet eye color'
  },
  es: {
